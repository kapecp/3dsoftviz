...
local N1 = {type = "node", id = inc(), label = "printMessage", params={size = 16, colorA = 1, colorR = 1, colorG = 0, colorB = 0}}
local N2 = {type = "node", id = inc(), label = "fileExists", params={size = 16, colorA = 1, colorR = 1, colorG = 0, colorB = 0}}
local N3 = {type = "node", id = inc(), label = "readFile", params={size = 16, colorA = 1, colorR = 1, colorG = 0, colorB = 0}}
local N4 = {type = "node", id = inc(), label = "tblPrint", params={size = 16, colorA = 1, colorR = 1, colorG = 0, colorB = 0}}
local N5 = {type = "node", id = inc(), label = "printKeys", params={size = 16, colorA = 1, colorR = 1, colorG = 0, colorB = 0}}
local N6 = {type = "node", id = inc(), label = "printValues", params={size = 16, colorA = 1, colorR = 1, colorG = 0, colorB = 0}}
local N7 = {type = "node", id = inc(), label = "mergeTbls", params={size = 16, colorA = 1, colorR = 1, colorG = 0, colorB = 0}}
local N8 = {type = "node", id = inc(), label = "testTbl", params={size = 16, colorA = 1, colorR = 1, colorG = 0, colorB = 0}}
local N9 = {type = "node", id = inc(), label = "proceedMerge", params={size = 16, colorA = 1, colorR = 1, colorG = 0, colorB = 0}}
local N10 = {type = "node", id = inc(), label = "print", params={size = 16, colorA = 1, colorR = 1, colorG = 0, colorB = 0}}
