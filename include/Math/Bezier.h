...
public:
	...
	inline osg::Vec3Array* getCtrlPoints()
	{
		return _ctrlPts.get();
	}
	inline const osg::Vec3Array* getCtrlPoints() const
	{
		return _ctrlPts.get();
	}

	/** Specifies the degree of the curve. Default is 3. */
	inline void setDegree( unsigned int k )
	{
		_degree=k;
		if ( _updated ) {
			_updated=false;
	...
	inline void setNumPath( unsigned int num )
	{
		_numPath=num;
		if ( _updated ) {
			_updated=false;
	...
	inline unsigned int getNumPath()
	{
		return _numPath;
	}
	 ...
	 */
	inline void setContinuity( double c )
	{
		_cont=c;
		if ( _updated ) {
			_updated=false;
...
public:
	...
	*/
	...
	inline unsigned int getDegreeU()
	{
		return _degreeU;
	}
	inline unsigned int getDegreeV()
	{
		return _degreeV;
	}
	...
	inline unsigned int getNumPathU()
	{
		return _numPathU;
	}
	inline unsigned int getNumPathV()
	{
		return _numPathV;
	}
