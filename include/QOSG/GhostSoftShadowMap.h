...
#ifndef OSGSHADOW_GHOSTSOFTSHADOWMAP
#define OSGSHADOW_GHOSTSOFTSHADOWMAP 1
...
/** GhostSoftShadowMap provides an implementation of soft shadows with shadow maps.*/
class OSGSHADOW_EXPORT GhostSoftShadowMap : public ShadowMap
{
public :
	GhostSoftShadowMap();

	GhostSoftShadowMap( const GhostSoftShadowMap& es, const osg::CopyOp& copyop=osg::CopyOp::SHALLOW_COPY );

	META_Object( osgShadow, GhostSoftShadowMap );
	...
	{
		setPolygonOffset( osg::Vec2( bias,0 ) );
	}
...
protected:
	virtual ~GhostSoftShadowMap( void ) {};
